...
public class MyOrders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ordersAdapter = new OrdersAdapter(MyOrders.this, orderList);
        listview = findViewById(R.id.MyOrder_listview_id);
    }
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                   ...
                   /* try {
                    ...
                    if (myorder.getDueStatus().equalsIgnoreCase("1") || myorder.getStatus().equalsIgnoreCase("0")) {
                        if(myorder.getUserid().equalsIgnoreCase(uid))
