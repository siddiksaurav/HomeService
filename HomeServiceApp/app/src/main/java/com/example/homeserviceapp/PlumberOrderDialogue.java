...
public class PlumberOrderDialogue extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setView(view).setTitle("Order details").setPositiveButton("okay", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Intent in = new Intent(getActivity(), PlumberList.class);
                startActivity(in);
               // getActivity().finish();
        ...
        SharedPreferences plumberdtails = getActivity().getSharedPreferences("plumbingOrder", Context.MODE_PRIVATE);
        String name = plumberdtails.getString("serviceName", "");
        String totalcost = plumberdtails.getString("cost", "");
